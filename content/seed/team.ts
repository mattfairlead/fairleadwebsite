...
export const team: HubTeamRow[] = [
  ...
  },
  {
    ...
    sort_order: 14,
    has_photo: false,
    show_on_website: false, // resigned; last day 11 Sept 2026 — uncheck "Website" in the hub too
    updated_at: SNAPSHOT_AT,
    extended_bio:
