 ...
 * video as its poster/fallback. `solid` drops the imagery entirely and
 * paints a flat --blue-950 ground — for sections that should read quiet.
 *
...
export default function ImageBand({
  ...
  return (
    ...
    >
      {/* far layer — sky (or the flat ground when solid) */}
      <div
        data-speed={parallax && !solid ? "0.85" : undefined}
